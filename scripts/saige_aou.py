...
def get_aou_util_path(
    ...
    assert name in [
        ...
        "sample_qc_tmp",
        "vep_corrected",
    ], 'Name has to be from ["ancestry_preds", "relatedness", "relatedness_flagged_samples", "vat", "sample_qc", "sample_qc_tmp", "vep_corrected"]'
...
############################### Remove once the docker image is ready#########################
